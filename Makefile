...
#$(BUILD)range_queries.o: Makefile config.make

include $(PWD)/config.make

range_queries.exe: $(BUILD)perfstats.o $(BUILD)range_queries.o $(BUILD)range_queries_main.o $(BUILD)range_queries_baseline.o 
	$(COMPILER) $(OPTIMIZE) $(MICROBENCH_OPTIMIZE) $(LIBS) $(BUILD)perfstats.o $(BUILD)range_queries.o $(BUILD)range_queries_main.o $(BUILD)range_queries_baseline.o -o range_queries.exe

$(BUILD)range_queries.o: OPTIMIZE=$(QUERY_OPTIMIZE)
